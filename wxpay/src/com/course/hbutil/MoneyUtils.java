...
public class MoneyUtils {
	private static String appid = "wxe570bee3f2f2e2e4";// 应用appID //wxa3a96a975a3d7848
	private static String appsecret = "29d457540f7076594afebe14faa65fb3";// 应用密钥Appsecert  
	private static String partner = "1251687301";// 微信支付商户号
	private static String partnerkey = "1q2w3e4r5t6y7u8i9o0p1a2s3d4f5g6h";// API密钥（32位）
	...
	final static String KEYSTORE_FILE = "E:/a/apiclient_cert.p12"; //pay.weixin.com在API安全的 中下载的证书中有的
	final static String KEYSTORE_PASSWORD = "1251687301";//初始默认微信支付商户号
